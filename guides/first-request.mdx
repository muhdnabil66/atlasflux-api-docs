---
title: "Send your first AtlasFlux API request"
description: "Step-by-step walkthrough for creating a test API key, exporting it as an environment variable, and sending your first AtlasFlux request with curl."
---
